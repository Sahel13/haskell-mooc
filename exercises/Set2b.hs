...
-- I'll assume that the input is always at least 1.
countdown :: Integer -> String
countdown n = "Ready! " ++ numberdown n ++ "Liftoff!"

numberdown :: Integer -> String
numberdown 0 = ""
numberdown n = show n ++ "... " ++ numberdown (n - 1)
